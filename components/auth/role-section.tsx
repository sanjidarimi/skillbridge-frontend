  ...
  return (
    <div className="grid grid-cols-2 gap-3 w-full">
      ...
      <button
        ...
        className={cn(
          "flex flex-col items-center justify-center p-3 rounded-xl border text-center transition-all gap-1.5 focus:outline-none focus:ring-2 focus:ring-primary/20",
          value === "student"
